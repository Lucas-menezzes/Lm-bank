...
class CustomUser(AbstractUser):
    ...
    groups = models.ManyToManyField(
        ...
        verbose_name=('groups'),
        blank=True,
        related_name='custom_user_groups'  # Adicione o related_name personalizado aqui
    )
    user_permissions = models.ManyToManyField(
        Permission,
        verbose_name=('user permissions'),
        blank=True,
        related_name='custom_user_permissions'  # Adicione o related_name personalizado aqui
    )
    
class Clients(CustomUser):
   # username = models.ForeignKey(CustomUser, on_delete=models.CASCADE)(max_length=150, unique=True)
